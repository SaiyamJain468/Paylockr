...
import { Lock, Calculator, Shield, TrendingUp, AlertCircle, Eye, EyeOff, X } from 'lucide-react';
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 text-center">
            <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
              ...
              <button onClick={onNavigateToSignup} className="text-blue-600 hover:text-blue-700 font-semibold">
                Sign Up
              </button>
            </p>
          </div>
          ...
          <div className="bg-black border-4 border-yellow-400 w-full max-w-md overflow-hidden animate-fade-in-up">
             ...
             <div className="p-2 space-y-1">
               <div className="px-4 py-2 border-b-2 border-gray-800">
                 <p className="text-xs font-black uppercase text-yellow-400">🎯 DEMO CREDENTIALS</p>
               </div>
               {DEMO_USERS.map(user => (
               ...
               <div className="px-4 py-2 border-t-2 border-b-2 border-gray-800 mt-2">
                 <p className="text-xs font-black uppercase text-green-400">✅ REAL GOOGLE SIGN-IN</p>
               </div>
               <button onClick={handleGoogleSignIn} disabled={isLoading} className="w-full flex items-center gap-4 p-4 hover:bg-gray-900 transition text-left group disabled:opacity-50">
                  ...
                  <p className="font-black uppercase text-white group-hover:text-cyan-400 transition-colors">
